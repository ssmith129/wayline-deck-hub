...
**Deck:** `wayline-deck.html` · 25 slides (numbered 1–26, no 19) · 16:9 · custom keyboard-driven HTML · full-length version only
**Path:** `wayline-deck-hub/wayline-deck-bundle/wayline-deck.html` (2,055 lines · modified 2026-05-24)
**Audited:** 2026-05-24
**Method:** Static parse of every slide on disk + asset-reference cross-check against the real `assets/` directory + visual inspection of changed/critical image assets.
...
**Motion-vs-static rule:** Motion (GIF/MP4) only when change over time is the point. Otherwise static.
